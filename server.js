...
//documents by deals id
app.post("/getdocumentsbydealsid",async(req,res)=>{
  const {id} = req.body;
  console.log(id);
  let access_token;
  ...
  if(myCache.has("accesstoken")){
   ...
   await axios.get(`https://creator.zoho.com.au/api/v2/nickprocterau_amaltrustees2/investment-portal/report/All_Documents?criteria=Deals.ID=${id}`, {
      headers: {
        Authorization: `Zoho-oauthtoken ${access_token}`
      },
    })
...
app.post("/getdealsbyid",async(req,res)=>{
  ...
  if(myCache.has("accesstoken")){
   ...
   await axios.get(`https://creator.zoho.com.au/api/v2/nickprocterau_amaltrustees2/investment-portal/report/All_Deals/${dealid}`, {
      headers: {
        Authorization: `Zoho-oauthtoken ${access_token}`
      },
    })
...
app.post("/dealswithuserid",async(req,res)=>{
  ...
  if(myCache.has("accesstoken")){
   ...
   await axios.get(`https://creator.zoho.com.au/api/v2/nickprocterau_amaltrustees2/investment-portal/report/All_Deals?criteria=ID=[${dealid}]`, {
      headers: {
        Authorization: `Zoho-oauthtoken ${access_token}`
      },
    })
...
app.post("/documentswithdealsid",async(req,res)=>{
  const {dealid} = req.body;
  console.log(dealid);
  let access_token;
  ...
  if(myCache.has("accesstoken")){
   ...
   await axios.get(`https://creator.zoho.com.au/api/v2/nickprocterau_amaltrustees2/investment-portal/report/All_Documents?criteria=((Deals.ID=${dealid}) %7C%7C (Access_Type="Global"))`, {
      headers: {
        Authorization: `Zoho-oauthtoken ${access_token}`
      },
    })
